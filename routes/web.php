...
Route::post('/profile/{id}','page\ProfileController@postEdit')->name('profile');
Route::get('/bookEvent/{id}','page\BookeventController@view')->name('booking');
Route::get('/addmoney/{id}','page\AddMoneyController@view')->name('addmoney');
Route::post('/addmoney/{id}','page\AddMoneyController@postAddMoney')->name('addmoney');
