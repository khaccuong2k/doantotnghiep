...
<section class="page-title bg-1">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="block text-center">
            ...
            <h1 class="text-capitalize mb-5 text-lg">Chúng Tôi Là Ai Và Làm Gì</h1>
  ...
  <section class="section about-page">
      <div class="container">
          <div class="row">
              <div class="col-lg-4">
                  <h2 class="title-color">Chất lượng và hiện đại</h2>
              </div>
              <div class="col-lg-8">
                  <p>Mang đến trải nghiệm âm nhạc thực thụ và chất lượng nhất đến với bạn</p>
          ...
          <div class="row">
              <div class="col-lg-3 col-md-6">
                  <div class="about-block-item mb-5 mb-lg-0">
                      ...
                      <h4 class="mt-3">Âm Nhạc Hiện Đại</h4>
                      <p>Thu thập từ các nhà phát triển hàng đầu .</p>
                  </div>
              </div>
              <div class="col-lg-3 col-md-6">
                  <div class="about-block-item mb-5 mb-lg-0">
                      <img src="images/about/about-2.jpg" alt="" class="img-fluid w-100">
                      <h4 class="mt-3">Tận Hường Cuộc Sống</h4>
                      <p>Mang đến trải nghiệm thư giản với những phút giây tuyệt vời .</p>
                  </div>
              </div>
              <div class="col-lg-3 col-md-6">
                  <div class="about-block-item mb-5 mb-lg-0">
                      <img src="images/about/about-3.jpg" alt="" class="img-fluid w-100">
                      <h4 class="mt-3">Bản Quyền Độc Quyền</h4>
                      <p>Chỉ cần là bạn, chúng tôi sẽ đáp ứng tất cả các nhu cầu .</p>
                  </div>
              </div>
              <div class="col-lg-3 col-md-6">
                  <div class="about-block-item">
                      <img src="images/about/about-4.jpg" alt="" class="img-fluid w-100">
                      <h4 class="mt-3">Cộng Đồng Hòa Nhập</h4>
                      <p>Với cộng đồng người sử dụng rất lớn, chúng tôi chắc chắn sẽ mang đến cho bạn sự thú vị nhất .</p>
                  </div>
              </div>
          </div>
      </div>
