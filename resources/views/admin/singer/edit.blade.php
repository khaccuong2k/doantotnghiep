...
<div class="col-lg-12">
    <div class="card">
        ...
        <form action="{{ route('edit-singer',[$idd->id]) }}" method="post" id="formUpdateAdmin" enctype="multipart/form-data" class="form-horizontal edit_admin">
            @csrf
            @foreach ($getId as $aa)
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <img id="output" src="{{asset('upload/img/img_singer')}}/{{ $aa->img }}" width="100" height="100">
