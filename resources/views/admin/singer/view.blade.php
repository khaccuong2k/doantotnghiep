                ...
                <div class="table-stats order-table ov-h">
                    <a href="{{ route('add-singer') }}">
                        <button class="btn btn-primary btn-sm rounded-0" type="button" data-placement="top" data-toggle="modal" data-target="#myModalCountry" title="Add">
                            Thêm Ca Sĩ <i class="fa fa-plus-square"></i>
                        </button>
                    </a>
                    <table class="table ">
                        <thead>
                        ...
                        <tbody>
                            @foreach ($singers as $item)
                                <tr>
                                    <td>
                                        <div>
                                        <a href="#"><img src="{{asset('upload/img/img_singer')}}/{{ $item->img }}" alt=""></a>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('edit-singer',[ $item->id ]) }}">
                                         ...
                                         <button class="btn btn-danger btn-sm rounded-0 del_singer" data-id="{{ $item->id }}" type="button" data-toggle="modal" data-target="#myModalCountry2" data-placement="top" title="Delete">
