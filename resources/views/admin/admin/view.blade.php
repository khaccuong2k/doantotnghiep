            ...
            <div class="card">
                ...
                <div class="table-stats order-table ov-h">
                    <table class="table ">
                        <thead>
                            <tr>
                                <th class="avatar">Hình đại diện</th>
                                <th>Họ tên</th>
                                <th>Email</th>
                                <th>Tên đăng nhập</th>
                                <th>Hành Động</th>
                        ...
                        <tbody>
                            @foreach ($admins as $ad)
                                <tr>
                                    <td class="avatar">
                                        <div class="round-img">
                                        <a href="#"><img class="rounded-circle" src="{{asset('upload/img/img_admin')}}/{{$ad->img}}" alt=""></a>
                                        </div>
                                    </td>
                                    <td>{{$ad->name}}</td>
                                    <td>{{$ad->email}}</td>
                                    ...
                                    <td>
                                        <a href=" {{ route('add-admin') }}">
                                            <button class="btn btn-primary btn-sm rounded-0" type="button" data-placement="top" data-toggle="modal" data-target="#myModal" title="Add">
                                                <i class="fa fa-plus-square"></i>
                                            </button>
                                        </a>
                                        <a href=" {{route('edit-admin',[ $ad->id ])}} ">
                                            <button class="btn btn-success btn-sm rounded-0 edit_admin" type="button" data-id="{{ $ad->id }}" title="Edit">
                                                <i class="fa fa-edit"></i>
                                            </button>
                                        </a>
                                    <button class="btn btn-danger btn-sm rounded-0 del_admin" data-id="{{ $ad->id }}" type="button" data-toggle="modal" data-target="#myModal2" data-placement="top" title="Delete">
